...
class _EditAttendanceSheetState extends State<EditAttendanceSheet> {
  ...
  void initState() {
    super.initState();
    _selectedStudentId = widget.attendance.studentId;
    _selectedClassroomId = widget.attendance.classroomId;
    try {
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      ...
      widget.cubit.updateAttendance(widget.attendance.id, data);
