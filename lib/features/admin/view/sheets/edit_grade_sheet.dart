...
class EditGradeSheet extends StatefulWidget {
  final GradeModel grade;
  final AdminLoaded state;
  final AdminCubit cubit;
  final bool isSuperAdmin;

  const EditGradeSheet({
    super.key,
    required this.grade,
    required this.state,
    required this.cubit,
  ...
  @override
  State<EditGradeSheet> createState() => _EditGradeSheetState();
}

class _EditGradeSheetState extends State<EditGradeSheet> {
  ...
  void initState() {
    ...
    _scoreCtrl.text = g.score?.toString() ?? '';
    _remarksCtrl.text = g.remarks ?? '';
    _selectedStudentId = g.studentId;
    _selectedExamId = g.examId;
  }
  ...
  void _submit() async {
    ...
    try {
      await widget.cubit.updateGrade(widget.grade.id, data);
