...
class AdminHelper {
  ...
  static InputDecoration inputDecoration(String label, {bool isRequired = false, String? hint}) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(value, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w600, color: Color(0xFF374151))),
